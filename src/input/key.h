...
namespace snuffbox
{
	/**
	* @class snuffbox::Key
	* @brief Contains an enumeration with all keys and key conversion functionality
	...
	*/
	...
	public:
		...
		* @return snuffbox::Key::Keys The actual converted keycode
		*/
		static Keys StringToKey(const char* name);
